...
$(function() {
  return $.get('/genes', function(genes) {
    var names;
    names = _.map(genes, function(gene) {
      return "" + gene.name + ": " + gene.description;
    });
    $('#js-rotating').text(names.join('|'));
    return $('#js-rotating').Morphext({
      separator: '|',
      animation: "bounceIn",
      speed: 2000
    });
...
},{"jquery":4,"sharify":5,"underscore":6}],2:[function(require,module,exports){
...
},{"../apps/genes/client.coffee":1,"../lib/vendor/morphext":3,"jquery":4}],3:[function(require,module,exports){
/*!
